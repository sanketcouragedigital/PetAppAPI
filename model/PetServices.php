...
{	
    ...
    public function mapIncomingGroomerModifyDetailsParams($id, $name, $description, $timing, $contact, $address, $city, $area, $email) {
        $this->setId($id);
        $this->setName($name);
        $this->setDescription($description);
        $this->setTiming($timing);        
    ...
    public function modifyingGroomerDetails() {
        $savePetServicesDAO = new PetServicesDAO();
        $returnPetServicesSaveSuccessMessage = $savePetServicesDAO->saveGroomerChanges($this);
        return $returnPetServicesSaveSuccessMessage;
    }

    public function mapIncomingShelterModifyDetailsParams($id, $name, $description, $timing, $contact, $address, $city, $area, $email) {
        $this->setId($id);
        $this->setName($name);
        $this->setDescription($description);
        $this->setTiming($timing);        
    ...
    public function modifyingShelterDetails() {
        $savePetServicesDAO = new PetServicesDAO();
        $returnPetServicesSaveSuccessMessage = $savePetServicesDAO->saveShelterChanges($this);
        return $returnPetServicesSaveSuccessMessage;
    }

    public function mapIncomingTrainerModifyDetailsParams($id, $name, $description, $timing, $contact, $address, $city, $area, $email) {
        $this->setId($id);
        $this->setName($name);
        $this->setDescription($description);
        $this->setTiming($timing);
    ...
    public function modifyingTrainerDetails() {
        $savePetServicesDAO = new PetServicesDAO();
        $returnPetServicesSaveSuccessMessage = $savePetServicesDAO->saveTrainerChanges($this);
        return $returnPetServicesSaveSuccessMessage;
    }
}
?>