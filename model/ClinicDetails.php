...
class ClinicDetails
{
    ...
    public function showingClinicToAdmin($currentPage) {
        $showClinicDetailsDAO = new ClinicDetailsDAO();
        $this->setCurrentPage($currentPage);        
        $returnShowClinicDetails = $showClinicDetailsDAO->showClinicForAdmin($this);
        return $returnShowClinicDetails;
    } 
    ...
    public function mapIncomingClinicModifyDetailsParams($id, $clinicName, $doctorName, $notesOfClinic, $contactNo, $clinicAddress, $clinicCity, $clinicArea, $email) {
        $this->setId($id);
        $this->setClinicName($clinicName);
        $this->setDoctorName($doctorName);
        $this->setClinicAddress($clinicAddress);
    ...
    public function modifyingClinicDetails() {
        $saveClinicDetailsDAO = new ClinicDetailsDAO();
        $returnModifyClinicDetails = $saveClinicDetailsDAO->saveClinicChanges($this);
        return $returnModifyClinicDetails;
    }
}
?>